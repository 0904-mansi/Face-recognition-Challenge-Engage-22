...
player = tkvideo("Face-recognition.mp4", video_label,
                 loop = 1, size = (400, 200))
player.play()
...
# tk.Label(text="Connect with me here 🤩 ", highlightbackground="#ffffff", highlightthickness=4,fg="#ffffff", 
#         font="Verdana 25 bold",bg ="#051729", pady=10).pack(padx=30)
...
tk.Label(text="Mansi Mishra (Microsoft Engage Mentee)" , fg="white",font="Verdana 20 bold",highlightbackground="#051729",bg="#051729", highlightthickness=4, ).pack(pady=10)
